...
!function(t, n) {
    ...
    r.prototype._bindHandles = function(t) {
        t = void 0 === t?!0 : !!t;
        var i;
        i = s.pointerEnabled ? function(n) {
            n.style.touchAction = t ? "none" : ""
        } : s.msPointerEnabled ? function(n) {
            n.style.msTouchAction = t ? "none" : ""
        } : function() {
            t && c(a)
        };
        for (var e = t ? "bind" : "unbind", o = 0, r = this.handles.length; r > o; o++) {
            var a = this.handles[o];
            this._bindStartEvent(a, t), i(a), n[e](a, "click", this)
        }
    };
    var p = "attachEvent"in document.documentElement, c = p ? function(t) {
        "IMG" == t.nodeName && (t.ondragstart = a);
        for (var n = t.querySelectorAll("img"), i = 0, e = n.length; e > i; i++) {
            var o = n[i];
            o.ondragstart = a
        }
    }
    : e;
    return r.prototype.pointerDown = function(t, n) {
        this._dragPointerDown(t, n);
        var i = document.activeElement;
        i && i.blur && i.blur(), this._bindPostStartEvents(t), this.emitEvent("pointerDown", [t, n])
    }, r.prototype._dragPointerDown = function(t, n) {
        this.pointerDownPoint = i.getPointerPoint(n);
        var e = "touchstart" == t.type, r = t.target.nodeName;
        e || "SELECT" == r || o(t)
    }, r.prototype.pointerMove = function(t, n) {
        var i = this._dragPointerMove(t, n);
        this.emitEvent("pointerMove", [t, n, i]), this._dragMove(t, n, i)
    }, r.prototype._dragPointerMove = function(t, n) {
        var e = i.getPointerPoint(n), o = {
            x: e.x - this.pointerDownPoint.x,
            y: e.y - this.pointerDownPoint.y
        };
    ...
    }, r.prototype._dragMove = function(t, n, i) {
        this.isDragging && this.dragMove(t, n, i)
    }, r.prototype.dragMove = function(t, n, i) {
        o(t), this.emitEvent("dragMove", [t, n, i])
        ...
        ("INPUT" == i || "TEXTAREA" == i) && t.target.focus(), this.staticClick(t, n)
...
!function(t, i) {
    ...
    "use strict";
    for (var s, n = 0, r = "webkit moz ms o".split(" "), o = t.requestAnimationFrame, h = t.cancelAnimationFrame, l = 0; l < r.length && (!o ||!h); l++)
        s = r[l], o = o || t[s + "RequestAnimationFrame"], h = h || t[s + "CancelAnimationFrame"] || t[s + "CancelRequestAnimationFrame"];
    o && h || (o = function(i) {
...
!function(t, e) {
    ...
    if ("function" == typeof define && define.amd)
        define(["classie/classie", "eventEmitter/EventEmitter", "eventie/eventie", "get-size/get-size", "fizzy-ui-utils/utils", "./cell", "./animate"], function(i, s, l, n, o, r, h) {
    ...
    c.defaults = {
        ...
        for (var s, l = this.cells.length, n = t; l > n; n++)
            s = this.cells[n], s.setPosition(e), e += s.size.outerWidth, this.maxCellHeight = Math.max(s.size.outerHeight, this.maxCellHeight);
...
!function(t, i) {
    "use strict";
    "function" == typeof define && define.amd ? define(["classie/classie", "eventie/eventie", "./flickity", "unidragger/unidragger", "fizzy-ui-utils/utils"], function(e, r, o, n, s) {
        return i(t, e, r, o, n, s)
    }) : "object" == typeof exports ? module.exports = i(t, require("desandro-classie"), require("eventie"), require("./flickity"), require("unidragger"), require("fizzy-ui-utils")) : t.Flickity = i(t, t.classie, t.eventie, t.Flickity, t.Unidragger, t.fizzyUIUtils)
}(window, function(t, i, e, r, o, n) {
    "use strict";
    function s(t) {
        t.preventDefault ? t.preventDefault() : t.returnValue=!1
    }
    function a(i) {
        var e = o.getPointerPoint(i);
        return e.y - t.pageYOffset
    }
    n.extend(r.defaults, {
        draggable: !0,
        touchVerticalScroll: !0
    }), r.createMethods.push("_createDrag"), n.extend(r.prototype, o.prototype), r.prototype._createDrag = function() {
        this.on("activate", this.bindDrag), this.on("uiChange", this._uiChangeDrag), this.on("childUIPointerDown", this._childUIPointerDownDrag), this.on("deactivate", this.unbindDrag)
    }, r.prototype.bindDrag = function() {
        this.options.draggable&&!this.isDragBound && (i.add(this.element, "is-draggable"), this.handles = [this.viewport], this.bindHandles(), this.isDragBound=!0)
    }, r.prototype.unbindDrag = function() {
        this.isDragBound && (i.remove(this.element, "is-draggable"), this.unbindHandles(), delete this.isDragBound)
    }, r.prototype._uiChangeDrag = function() {
        delete this.isFreeScrolling
    }, r.prototype._childUIPointerDownDrag = function(t) {
        s(t), this.pointerDownFocus(t)
    }, r.prototype.pointerDown = function(t, e) {
        this._dragPointerDown(t, e);
        var r = document.activeElement;
        r && r.blur && r != this.element && r != document.body && r.blur(), this.pointerDownFocus(t), this.dragX = this.x, i.add(this.viewport, "is-pointer-down"), this._bindPostStartEvents(t), this.dispatchEvent("pointerDown", t, [e])
    };
    var h = {
        touchstart: !0,
        MSPointerDown: !0
    ...
    r.prototype.pointerDownFocus = function(t) {
        !this.options.accessibility || h[t.type] || l[t.target.nodeName] || this.element.focus()
    }, r.prototype.pointerMove = function(t, i) {
        var e = this._dragPointerMove(t, i);
        this.touchVerticalScrollMove(t, i, e), this._dragMove(t, i, e), this.dispatchEvent("pointerMove", t, [i, e])
    }, r.prototype.hasDragStarted = function(t) {
        return !this.isTouchScrolling && Math.abs(t.x) > 3
    }, r.prototype.pointerUp = function(t, e) {
        delete this.isTouchScrolling, i.remove(this.viewport, "is-pointer-down"), this.dispatchEvent("pointerUp", t, [e]), this._dragPointerUp(t, e)
    };
    var c = {
        touchmove: !0,
        MSPointerMove: !0
    };
    return r.prototype.touchVerticalScrollMove = function(i, e, r) {
        var o = this.options.touchVerticalScroll, n = "withDrag" == o?!o : this.isDragging ||!o;
        !n && c[i.type]&&!this.isTouchScrolling && Math.abs(r.y) > 10 && (this.startScrollY = t.pageYOffset, this.pointerWindowStartY = a(e), this.isTouchScrolling=!0)
    }, r.prototype.dragStart = function(t, i) {
        this.dragStartPosition = this.x, this.startAnimation(), this.dispatchEvent("dragStart", t, [i])
    }, r.prototype.dragMove = function(t, i, e) {
        s(t), this.previousDragX = this.dragX;
        var r = this.options.rightToLeft?-1 : 1, o = this.dragStartPosition + e.x * r;
        ...
        this.dragX = o, this.dragMoveTime = new Date, this.dispatchEvent("dragMove", t, [i, e])
    }, r.prototype.dragEnd = function(t, i) {
        this.options.freeScroll && (this.isFreeScrolling=!0);
        var e = this.dragEndRestingSelect();
        if (this.options.freeScroll&&!this.options.wrapAround) {
            var r = this.getRestingDragPosition();
            this.isFreeScrolling =- r > this.cells[0].target&&-r < this.getLastCell().target
        } else 
            this.options.freeScroll || e != this.selectedIndex || (e += this.dragEndBoostSelect());
        delete this.previousDragX, this.select(e), this.dispatchEvent("dragEnd", t, [i])
    }, r.prototype.dragEndRestingSelect = function() {
        var t = this.getRestingDragPosition(), i = Math.abs(this.getCellDistance( - t, this.selectedIndex)), e = this._getClosestResting(t, i, 1), r = this._getClosestResting(t, i, - 1), o = e.distance < r.distance ? e.index: r.index;
        return o
    }, r.prototype.getRestingDragPosition = function() {
        var t = this.dragX - this.x;
        return this.x + t / (1 - this.getFrictionFactor())
    }, r.prototype._getClosestResting = function(t, i, e) {
        for (var r = this.selectedIndex, o = 1 / 0, n = this.options.contain&&!this.options.wrapAround ? function(t, i) {
            return i >= t
        } : function(t, i) {
            return i > t
        }; n(i, o) && (r += e, o = i, i = this.getCellDistance( - t, r), null !== i);)
            i = Math.abs(i);
        return {
            distance: o,
            index: r - e
        }
    }, r.prototype.getCellDistance = function(t, i) {
        var e = this.cells.length, r = this.options.wrapAround && e > 1, o = r ? n.modulo(i, e): i, s = this.cells[o];
        if (!s)
            return null;
        var a = r ? this.slideableWidth * Math.floor(i / e): 0;
        return t - (s.target + a)
    }, r.prototype.dragEndBoostSelect = function() {
        if (void 0 === this.previousDragX ||!this.dragMoveTime || new Date - this.dragMoveTime > 100)
            return 0;
        var t = this.getCellDistance( - this.dragX, this.selectedIndex), i = this.previousDragX - this.dragX;
        return t > 0 && i > 0 ? 1 : 0 > t && 0 > i?-1 : 0
    }, r.prototype.staticClick = function(t, i) {
        var e = this.getParentCell(t.target), r = e && e.element, o = e && n.indexOf(this.cells, e);
        this.dispatchEvent("staticClick", t, [i, r, o])
    }, r
});
!function(t, e) {
    "use strict";
...
!function(e, t) {
    ...
    return t.prototype.insert = function(e, t) {
        ...
        var t, l, s, n = this.getCells(e), c = 0;
        for (t = 0, l = n.length; l > t; t++) {
            s = n[t];
            var o = i.indexOf(this.cells, s) < this.selectedIndex;
            c -= o ? 1 : 0
        }
        for (t = 0, l = n.length; l > t; t++)
            s = n[t], s.remove(), i.removeFrom(this.cells, s);
        n.length && this._cellAddedRemoved(0, c)
    }, t.prototype._cellAddedRemoved = function(e, t) {
        t = t || 0, this.selectedIndex += t, this.selectedIndex = Math.max(0, Math.min(this.cells.length - 1, this.selectedIndex)), this.emitEvent("cellAddedRemoved", [e, t]), this.cellChange(e)
        ...
        this._positionCells(e), this._getWrapShiftCells(), this.setGallerySize(), this.options.freeScroll ? this.positionSlider() : this.select(this.selectedIndex)
    }, t
});
!function(t, i) {
    "use strict";
...
!function(t, e) {
    ...
    }, g = 0, y = "webkit moz ms o".split(" "), f = t.requestAnimationFrame, m = t.cancelAnimationFrame, v = 0; v < y.length && (!f ||!m); v++)
        h = y[v], f = f || t[h + "RequestAnimationFrame"], m = m || t[h + "CancelAnimationFrame"] || t[h + "CancelRequestAnimationFrame"];
    f && m || (f = function(e) {
...
FlickityDocs.modules.append = function(e) {
    "use strict";
    var l = e.querySelector(".gallery"), i = new Flickity(l, {
        initialIndex: 2
    }), t = i.cells.length + 1, c = FlickityDocs.makeCellElem, n = e.querySelector(".button");
...
FlickityDocs.modules["arrow-wiz"] = function(e) {
    ...
    var m = y.querySelector(".arrow-wiz-code code"), q = new Flickity(y.querySelector(".gallery"), {
        initialIndex: 2
    }), b = q.prevButton.element.querySelector("path"), L = q.nextButton.element.querySelector("path");
    x()
};
...
FlickityDocs.modules.insert = function(e) {
    "use strict";
    var i = e.querySelector(".gallery"), l = new Flickity(i, {
        initialIndex: 1
    }), t = l.cells.length + 1, c = FlickityDocs.makeCellElem, n = e.querySelector(".button");
    eventie.bind(n, "click", function() {
        var e = [c(t++), c(t++)];
        l.insert(e, 2)
    })
...
FlickityDocs.modules.remove = function(e) {
    "use strict";
    var i = e.querySelector(".gallery"), t = new Flickity(i, {
        initialIndex: 1
    });
...
FlickityDocs.modules["static-click"] = function(i) {
    "use strict";
    var e = window.fizzyUIUtils, c = i.querySelector(".gallery"), l = new Flickity(c, {
        initialIndex: 1
